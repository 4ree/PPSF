 ...
 */
public class DescriptionAlgoMSU_MIU extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoMSU_MIU(){
	...
	public void runPPMFAlgorithm(String[] parameters, String inputDatabaseFile, String inputSensitiveFile, String outputFile) throws IOException {
		...
		algorithms.PPUM.AlgoMSU_MIU algorithm = new algorithms.PPUM.AlgoMSU_MIU();

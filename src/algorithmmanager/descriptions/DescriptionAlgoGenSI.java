 ...
 */
public class DescriptionAlgoGenSI extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoGenSI(){
	...
	public void runPPMFAlgorithm(String[] parameters, String inputDatabaseFile, String inputSensitiveFile, String outputFile) throws IOException {
		...
		algorithms.PPUM.AlgoGenSI algorithm = new algorithms.PPUM.AlgoGenSI();

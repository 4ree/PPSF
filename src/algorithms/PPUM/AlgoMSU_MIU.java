...
public class AlgoMSU_MIU extends PPUM {
	...
	private void addressTIDandItem(String sk) {
		List<String> items = getKeys(sk);
		double minItemUtility = Double.MAX_VALUE;
		double maxMSU = 0;
...
//		String miningResult = "temp_file/hui_mine_result.txt";
		...
		String out=path+"/"+mut +"/"+ name + "_MSU_MIU"+"_h_"+ String.valueOf(min_util*100)+"_si_"+sensitiveThreshold+".txt";
